        ...
        switch (Op) {
            ...
            case "Loguin":
                ...
                try {
                    ...
                    ps.setString(1, Herramientas.EntidadesGlobales.getFecha());
                    ps.setString(2, Herramientas.EntidadesGlobales.getHora());
                    ps.setString(3, user.getCodUsuario());
                    ps.executeUpdate();

                    Herramientas.EntidadesGlobales.setUser(user);
            ...
            case "CerrarSesion":
                ...
                String CodUsuario = Herramientas.EntidadesGlobales.getUser().getCodUsuario();
                ...
                Herramientas.EntidadesGlobales.setUser(null);
                request.getRequestDispatcher("/Login.jsp").forward(request, response);
